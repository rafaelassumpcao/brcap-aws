...
exports.sqsGetPromise = function sqsGetPromise(queueURL, region) {
  return new SQS(region).get(queueURL);
};
...
exports.sqsDeletePromise = function sqsDeletePromise(queueURL, receiptHandle, region) {
  return new SQS(region).delete(queueURL, receiptHandle);
};
